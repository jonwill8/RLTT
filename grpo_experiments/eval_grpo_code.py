#!/usr/bin/env python3
"""
Evaluate GRPO checkpoint on Code Generation benchmarks (HumanEval, MBPP).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate GRPO checkpoint on code generation benchmarks")
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("GRPO Checkpoint Code Generation Evaluation")
    logger.info("=" * 60)
    ...
    with open(summary_file, "w") as f:
        f.write("GRPO Checkpoint Code Generation Evaluation Summary\n")
        f.write("=" * 50 + "\n\n")
