#!/usr/bin/env python3
"""
Evaluate SFT checkpoint on MCQA benchmarks (ARC-Challenge, MMLU-STEM, GPQA).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate SFT checkpoint on MCQA benchmarks")
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("SFT Checkpoint MCQA Evaluation")
    logger.info("=" * 60)
    ...
    with open(summary_file, "w") as f:
        f.write("SFT Checkpoint MCQA Evaluation Summary\n")
        f.write("=" * 40 + "\n\n")
