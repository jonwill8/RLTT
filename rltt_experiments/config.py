...
class RLTTConfig:
    ...
    # - uniform: ω_t = 1/T_max for all t (Option A in paper)
    # - progressive: ω_t = t^α / Σ s^α (Option B in paper)
    ...
    # α = 0 gives uniform weights
    # α = 1 gives linear weights (1, 2, 3, ..., T_max)
    # α = 2 gives quadratic weights (1, 4, 9, ..., T_max^2)
