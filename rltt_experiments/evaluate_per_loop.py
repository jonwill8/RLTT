#!/usr/bin/env python3
"""
Per-Loop Evaluation Script for RLTT Checkpoints

This script evaluates an RLTT checkpoint with a fixed number of recursive loops
...
def main():
    parser = argparse.ArgumentParser(
        description="Per-loop evaluation of RLTT checkpoints"
    )
    ...
    logger.info("=" * 70)
    logger.info(f"RLTT Per-Loop Evaluation")
    logger.info("=" * 70)
    ...
    with open(summary_file, "w") as f:
        f.write("RLTT Per-Loop Evaluation Summary\n")
        f.write("=" * 50 + "\n\n")
