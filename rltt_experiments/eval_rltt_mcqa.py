#!/usr/bin/env python3
"""
Evaluate RLTT checkpoint on MCQA benchmarks (ARC-Challenge, MMLU-STEM, GPQA).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate RLTT checkpoint on MCQA benchmarks")
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("RLTT Checkpoint MCQA Evaluation")
    logger.info("=" * 60)
    ...
    with open(summary_file, "w") as f:
        f.write("RLTT Checkpoint MCQA Evaluation Summary\n")
        f.write("=" * 40 + "\n\n")
