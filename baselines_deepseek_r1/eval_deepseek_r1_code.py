#!/usr/bin/env python3
"""
Evaluate DeepSeek-R1-Distill-Qwen models on Code Generation benchmarks (HumanEval, MBPP).

This script evaluates DeepSeek-R1-Distill-Qwen baseline models (1.5B, 7B) by:
...
Usage:
    python eval_deepseek_r1_code.py \
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate DeepSeek-R1-Distill-Qwen on code generation benchmarks")
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to DeepSeek-R1-Distill-Qwen model directory"
    )
...
def format_humaneval_prompt(
    ...
    """Format a HumanEval prompt for DeepSeek-R1."""
...
def format_mbpp_prompt(
    ...
    """Format an MBPP prompt for DeepSeek-R1."""
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("DeepSeek-R1-Distill-Qwen Baseline Code Generation Evaluation")
    logger.info("=" * 60)
    ...
    with open(summary_file, "w") as f:
        f.write("DeepSeek-R1-Distill-Qwen Baseline Code Generation Evaluation Summary\n")
        f.write("=" * 60 + "\n\n")
