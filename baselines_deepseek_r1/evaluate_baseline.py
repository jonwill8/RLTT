#!/usr/bin/env python3
"""
Baseline Evaluation Script for DeepSeek-R1-Distill-Qwen models on math benchmarks.

Evaluates DeepSeek-R1-Distill-Qwen-1.5B and DeepSeek-R1-Distill-Qwen-7B on
MATH-500, GSM8K, AIME24, and BeyondAIME.
...
def evaluate_baseline(config: BaselineEvalConfig) -> Dict[str, Any]:
    """Evaluate DeepSeek-R1-Distill-Qwen model on test dataset using vLLM.

    Returns:
        Dictionary containing metrics and detailed results.
    """
    logger.info("=" * 60)
    logger.info("DeepSeek-R1-Distill-Qwen Baseline Evaluation")
    logger.info("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate DeepSeek-R1-Distill-Qwen models on math benchmarks")
