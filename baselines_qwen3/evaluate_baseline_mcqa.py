#!/usr/bin/env python3
"""
Baseline Evaluation Script for Qwen3 models on MCQA benchmarks.

Evaluates Qwen3-1.7B and Qwen3-4B on ARC-Challenge, MMLU-STEM, and GPQA.
...
def evaluate_baseline_mcqa(config: BaselineMCQAEvalConfig) -> Dict[str, Any]:
    """Evaluate Qwen3 model on MCQA test dataset using vLLM.

    Returns:
        Dictionary containing metrics and detailed results.
    """
    logger.info("=" * 60)
    logger.info("Qwen3 Baseline Evaluation (MCQA)")
    logger.info("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate Qwen3 models on MCQA benchmarks")
