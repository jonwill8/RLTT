#!/usr/bin/env python3
"""
Generate Model Rollouts for GRPO Experiments
...
def find_merged_model(experiment_dir: str, checkpoint: str) -> Optional[str]:
    ...
    temp_dir = os.path.join(pass_at_k_dir, f"temp_grpo_{exp_id}_{checkpoint}", "merged_model")
...
def main():
    parser = argparse.ArgumentParser(description="Generate greedy rollouts for GRPO experiments")
    ...
    logger.info("=" * 60)
    logger.info("GRPO Greedy Rollout Generation")
    logger.info("=" * 60)
